...
class ShoppingCart(models.Model): # пустая корзина
    ...
    def get_total_price_sum(self):
        ...
        total = sum([item.get_total_price_item() for item in cart_items]) # типа reduce функции
        return total
...
class CartItem(models.Model): # корзина с товарами
